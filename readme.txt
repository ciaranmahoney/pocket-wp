...
`credit: yes, no // Choose to add author credit. Plugin will not show author credit by default.`
...
`author credit: yes, no // Choose to give author credit. It does not display credit by default.`
